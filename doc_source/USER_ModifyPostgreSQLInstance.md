...
|  Enhanced Monitoring  |  **Yes** to enable gathering metrics in real time for the operating system that your DB instance runs on\.  For more information, see [Enhanced Monitoring](USER_Monitoring.OS.md)\.   | – | – | 
...
|  License Model  |  You cannot change the license model because PostgreSQL has only one license model\.  | – | – | 

# Working with Amazon RDS database log files<a name="USER_LogAccess"></a>
...
**Topics**
+ [Viewing and listing database log files](#USER_LogAccess.Procedural.Viewing)
+ [Downloading a database log file](#USER_LogAccess.Procedural.Downloading)
+ [Watching a database log file](#USER_LogAccess.Procedural.Watching)
+ [Publishing database logs to Amazon CloudWatch Logs](#USER_LogAccess.Procedural.UploadtoCloudWatch)
+ [Reading log file contents using REST](#DownloadCompleteDBLogFile)
...
+ [Accessing MySQL database log files](USER_LogAccess.Concepts.MySQL.md)

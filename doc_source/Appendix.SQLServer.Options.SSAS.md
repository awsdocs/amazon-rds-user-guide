...
To download model configuration files to your host for deployment, use Amazon S3 integration\. For more information, see [](User.SQLServer.Options.S3-integration.md)\.
...
+ Amazon S3 integration is turned on\. For more information, see [](User.SQLServer.Options.S3-integration.md)\.

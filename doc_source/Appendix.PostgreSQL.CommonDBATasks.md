...
You also can't access log files in the same way that you do with an on\-premises PostgreSQL instance\. To learn more about logging, see [PostgreSQL database log files](USER_LogAccess.Concepts.PostgreSQL.md)\.

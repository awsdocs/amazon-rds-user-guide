...
| Instance Class | vCPU1 | ECU2 | Memory3 \(GiB\) | VPC Only4 | EBS Optimized5 | Max\. Bandwidth6 \(Mbps\) | Network Performance7 | MariaDB | Microsoft SQL Server8 | MySQL9 | Oracle10 | PostgreSQL | 
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | 
| db\.m4 – Latest Generation Standard Instance Classes | 
| db\.m4\.16xlarge | 64 | 188 | 256 | Yes | Yes | 10,000 | 25 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | Yes | 
| db\.m4\.10xlarge | 40 | 124\.5 | 160 | Yes | Yes | 4,000 | 10 Gbps | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m4\.4xlarge | 16 | 53\.5 | 64 | Yes | Yes | 2,000 | High | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m4\.2xlarge | 8 | 25\.5 | 32 | Yes | Yes | 1,000 | High | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m4\.xlarge | 4 | 13 | 16 | Yes | Yes | 750 | High | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m4\.large | 2 | 6\.5 | 8 | Yes | Yes | 450 | Moderate | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m3 – Previous Generation Standard Instance Classes | 
| db\.m3\.2xlarge | 8 | 26 | 30 | No | Yes | 1,000 | High | No | Yes8 | Yes | Yes10 | Yes | 
| db\.m3\.xlarge | 4 | 13 | 15 | No | Yes | 500 | High | No | Yes8 | Yes | Yes10 | Yes | 
| db\.m3\.large | 2 | 6\.5 | 7\.5 | No | No | — | Moderate | No | Yes8 | Yes | Yes10 | Yes | 
| db\.m3\.medium | 1 | 3 | 3\.75 | No | No | — | Moderate | No | Yes8 | Yes | Yes10 | Yes | 
| db\.m1 – Previous Generation Standard Instance Classes | 
| db\.m1\.xlarge | 4 | 4 | 15 | No | Yes | 450 | High | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.m1\.large | 2 | 2 | 7\.5 | No | Yes | 450 | Moderate | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.m1\.medium | 1 | 1 | 3\.75 | No | No | — | Moderate | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.m1\.small | 1 | 1 | 1\.7 | No | No | — | Very Low | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.x1e – Latest Generation Memory Optimized Instance Classes | 
| db\.x1e\.32xlarge | 128 | 340 | 3,904 | Yes | Yes | 14,000 | 25 Gbps | No | No | No | Yes10 | No | 
| db\.x1e\.16xlarge | 64 | 179 | 1,952 | Yes | Yes | 7,000 | 10 Gbps | No | No | No | Yes10 | No | 
| db\.x1e\.8xlarge | 32 | 91 | 976 | Yes | Yes | 3,500 | Up to 10 Gbps | No | No | No | Yes10 | No | 
| db\.x1e\.4xlarge | 16 | 47 | 488 | Yes | Yes | 1,750 | Up to 10 Gbps | No | No | No | Yes10 | No | 
| db\.x1e\.2xlarge | 8 | 23 | 244 | Yes | Yes | 1,000 | Up to 10 Gbps | No | No | No | Yes10 | No | 
| db\.x1e\.xlarge | 4 | 12 | 122 | Yes | Yes | 500 | Up to 10 Gbps | No | No | No | Yes10 | No | 
| db\.x1 – Current Generation Memory Optimized Instance Classes | 
| db\.x1\.32xlarge | 128 | 349 | 1,952 | Yes | Yes | 14,000 | 25 Gbps | No | No | No | Yes10 | No | 
| db\.x1\.16xlarge | 64 | 349 | 976 | Yes | Yes | 7,000 | 10 Gbps | No | No | No | Yes10 | No | 
| db\.r4 – Current Generation Memory Optimized Instance Classes | 
| db\.r4\.16xlarge | 64 | 195 | 488 | Yes | Yes | 14,000 | 25 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r4\.8xlarge | 32 | 99 | 244 | Yes | Yes | 7,000 | 10 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r4\.4xlarge | 16 | 53 | 122 | Yes | Yes | 3,500 | Up to 10 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r4\.2xlarge | 8 | 27 | 61 | Yes | Yes | 1,750 | Up to 10 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r4\.xlarge | 4 | 13\.5 | 30\.5 | Yes | Yes | 875 | Up to 10 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r4\.large | 2 | 7 | 15\.25 | Yes | Yes | 437 | Up to 10 Gbps | Yes | Yes8 | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.r3 – Previous Generation Memory Optimized Instance Classes | 
| db\.r3\.8xlarge | 32 | 104 | 244 | No | No | — | 10 Gbps | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.r3\.4xlarge | 16 | 52 | 122 | No | Yes | 2,000 | High | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.r3\.2xlarge | 8 | 26 | 61 | No | Yes | 1,000 | High | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.r3\.xlarge | 4 | 13 | 30\.5 | No | Yes | 500 | Moderate | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.r3\.large | 2 | 6\.5 | 15\.25 | No | No | — | Moderate | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.m2 – Previous Generation Memory Optimized Instance Classes | 
| db\.m2\.4xlarge | 8 | 26 | 68\.4 | No | Yes | 1,000 | High | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.m2\.2xlarge | 4 | 13 | 34\.2 | No | Yes | 500 | Moderate | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.m2\.xlarge | 2 | 6\.5 | 17\.1 | No | No | — | Moderate | No | Yes8 | MySQL 5\.6, 5\.5 | Deprecated10 | PostgreSQL 9\.4, 9\.3 | 
| db\.t2 – Current Generation Burstable Performance Instance Classes | 
| db\.t2\.2xlarge | 8 | 8 | 32 | Yes | No | — | Moderate | Yes | No | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.t2\.xlarge | 4 | 4 | 16 | Yes | No | — | Moderate | Yes | No | MySQL 5\.7, 5\.69 | Yes10 | PostgreSQL 9\.6, 9\.5, 9\.4 | 
| db\.t2\.large | 2 | 2 | 8 | Yes | No | — | Moderate | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.t2\.medium | 2 | 2 | 4 | Yes | No | — | Moderate | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.t2\.small | 1 | 1 | 2 | Yes | No | — | Low | Yes | Yes8 | Yes | Yes10 | Yes | 
| db\.t2\.micro | 1 | 1 | 1 | Yes | No | — | Low | Yes | Yes8 | Yes | Yes10 | Yes | 
...
+ [create\-db\-instance](http://docs.aws.amazon.com/cli/latest/reference/rds/create-db-instance.html)
...
You can view the valid processor values for a particular DB instance class by running the [describe\-orderable\-db\-instance\-options](http://docs.aws.amazon.com/cli/latest/reference/rds/describe-orderable-db-instance-options.html) command and specifying the instance class for the `--db-instance-class` option\. For example, the output for the following command shows the processor options for the db\.r3\.large instance class\.  
...
+ [describe\-db\-instances](http://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-instances.html) – Shows the processor information for the specified DB instance\.
+ [describe\-db\-snapshots](http://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-snapshots.html) – Shows the processor information for the specified DB snapshot\.
+ [describe\-valid\-db\-instance\-modifications](http://docs.aws.amazon.com/cli/latest/reference/rds/describe-valid-db-instance-modifications.html) – Shows the valid modifications to the processor for the specified DB instance\.
...
You can view the valid processor values for a particular instance class by running the [DescribeOrderableDBInstanceOptions](http://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeOrderableDBInstanceOptions.html) action and specifying the instance class for the `DBInstanceClass` parameter\.

In addition, you can use the following actions for DB instance class processor information:
+ [DescribeDBInstances](http://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBInstances.html) – Shows the processor information for the specified DB instance\.
+ [DescribeDBSnapshots](http://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeDBSnapshots.html) – Shows the processor information for the specified DB snapshot\.
+ [DescribeValidDBInstanceModifications](http://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DescribeValidDBInstanceModifications.html) – Shows the valid modifications to the processor for the specified DB instance\.
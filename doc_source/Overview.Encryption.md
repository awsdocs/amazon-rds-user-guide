...
**Note**  
For encrypted and unencrypted DB instances with cross\-region Read Replicas, data that is in transit between the source and the Read Replicas is encrypted\.

...
1. Select the DB snapshot that you want to delete\.
...
You can delete a DB snapshot by using the Amazon RDS API action [DeleteDBSnapshot](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DeleteDBSnapshot.html)\. 

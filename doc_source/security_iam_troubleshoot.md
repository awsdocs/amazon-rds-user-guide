# Troubleshooting Amazon RDS Identity and Access<a name="security_iam_troubleshoot"></a>
...
## I'm an Administrator and Want to Allow Others to Access Amazon RDS<a name="security_iam_troubleshoot-admin-delegate"></a>

...
## MySQL memcached Security Considerations<a name="w4aac28c74c15c10"></a>
...
## MySQL memcached Connection Information<a name="w4aac28c74c15c12"></a>
...
## MySQL memcached Option Settings<a name="w4aac28c74c15c14"></a>

Amazon RDS exposes the MySQL `memcached` parameters as option settings in the Amazon RDS `MEMCACHED` option\.

### MySQL memcached Parameters<a name="w4aac28c74c15c14b4"></a>
...
### MySQL `daemon_memcached_options` Parameters<a name="w4aac28c74c15c14b6"></a>

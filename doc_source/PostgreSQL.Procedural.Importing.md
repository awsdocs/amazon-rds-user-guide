...
### Step 1: Create a file using `pg_dump` that contains the data to be loaded<a name="PostgreSQL.Procedural.Importing.EC2.Step1"></a>
...
### Step 3: Use *psql* to create the database on the DB instance and load the data<a name="PostgreSQL.Procedural.Importing.EC2.Step3"></a>

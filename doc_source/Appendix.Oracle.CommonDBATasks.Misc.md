...
After HugePages are active on your DB instance, you can view HugePages information by enabling enhanced monitoring\. For more information, see [Tracking OS metrics using Enhanced Monitoring](USER_Monitoring.OS.md)\. 

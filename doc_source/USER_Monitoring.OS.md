...
### Available OS Metrics<a name="w53aac21c17c21b7"></a>

The following tables list the OS metrics available using Amazon CloudWatch Logs\.

#### Metrics for MariaDB, MySQL, Oracle, and PostgreSQL DB instances<a name="w53aac21c17c21b7b5"></a>
...
#### Metrics for Microsoft SQL Server DB instances<a name="w53aac21c17c21b7b9"></a>

...
| FreeLocalStorage |   **Free Local Storage \(MB\)**   |  The amount of available local storage space\. Applies to only Multi\-AZ DB clusters\. \(This doesn't apply to Aurora Serverless v2\.\)  |  Bytes  | 

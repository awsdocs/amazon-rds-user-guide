...
| --- | --- | --- | --- | 
|  Allocated storage  |  The storage, in gigabytes, that you want to allocate for your DB instance\.  For more information, see [DB instance storage](CHAP_Storage.md)\.   |  If **Apply immediately** is set to true, the change occurs immediately\.  If **Apply immediately** is set to false, the change occurs during the next maintenance window\.   |  No downtime\. Performance may be degraded during the change\.   | 

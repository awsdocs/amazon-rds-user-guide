...
1. For **DB instance class**, choose a DB instance class\. For supported instance classes, see the **DB instance class** row in [Settings for creating Multi\-AZ DB clusters](#create-multi-az-db-cluster-settings)\.

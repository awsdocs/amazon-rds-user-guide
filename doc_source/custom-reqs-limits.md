...
+ Use only the approved database installation and patch files\. For more information, see [Step 2: Downloading your database installation files and patches from Oracle Software Delivery Cloud](custom-cev.preparing.md#custom-cev.preparing.download)\.

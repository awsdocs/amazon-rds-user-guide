...
1. In the **Select Engine** window, click the **Select** button for the MySQL DB engine\. 
...
![\[Specify DB Details\]](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/MySQL-Launch02.png)
...
![\[Configure Advanced Settings\]](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/MySQL-Launch03.png)

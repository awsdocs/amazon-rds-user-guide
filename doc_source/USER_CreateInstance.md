...
## AWS Management Console<a name="USER_CreateInstance.CON"></a>
...
1. The **Choose use case** page asks if you are planning to use the DB instance you are creating for production\. If you are, choose **Production \- MySQL**\. If you choose **Production \- MySQL**, the failover option **Multi\-AZ** and the **Provisioned IOPS** storage option are preselected in the following step\. We recommend these features for any production environment\. 
...
![\[Specify DB details\]](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/MySQL-Launch02a.png)
...
```
1. DBINSTANCE  mydbinstance  db.m3.medium  mysql  20  sa  creating  3  ****  n  5.6.27
...
|  IAM DB authentication  |  **Enable IAM DB authentication** to enable IAM database authentication for this DB instance\.  For more information, see [IAM Database Authentication for MySQL and Amazon Aurora](UsingWithRDS.IAMDBAuth.md)\.   | 

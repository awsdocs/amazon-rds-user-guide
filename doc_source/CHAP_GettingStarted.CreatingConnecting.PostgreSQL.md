...
+ [Step 1: Create a PostgreSQL DB instance](#CHAP_GettingStarted.Creating.PostgreSQL)
+ [Step 2: Create an EC2 instance](#CHAP_GettingStarted.Creating.RDSPostgreSQL.EC2)
+ [Step 3: Connect your EC2 instance and PostgreSQL DB instance automatically](#CHAP_GettingStarted.Connecting.EC2.PostgreSQL)
+ [Step 4: Connect to a PostgreSQL DB instance](#CHAP_GettingStarted.Connecting.PostgreSQL)
+ [Step 5: Delete the EC2 instance and DB instance](#CHAP_GettingStarted.Deleting.PostgreSQL)
...
## Step 1: Create a PostgreSQL DB instance<a name="CHAP_GettingStarted.Creating.PostgreSQL"></a>
...
## Step 2: Create an EC2 instance<a name="CHAP_GettingStarted.Creating.RDSPostgreSQL.EC2"></a>
...
## Step 3: Connect your EC2 instance and PostgreSQL DB instance automatically<a name="CHAP_GettingStarted.Connecting.EC2.PostgreSQL"></a>

You can automatically connect an existing EC2 instance to a DB instance using the RDS console\. The RDS console simplifies setting up the connection between an EC2 instance and your PostgreSQL DB instance\. For this tutorial, set up a connection between the EC2 instance and the PostgreSQL DB instance that you created previously\.
...
## Step 4: Connect to a PostgreSQL DB instance<a name="CHAP_GettingStarted.Connecting.PostgreSQL"></a>
...
## Step 5: Delete the EC2 instance and DB instance<a name="CHAP_GettingStarted.Deleting.PostgreSQL"></a>
